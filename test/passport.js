...
describe('authenticate user middleware', () => {
  ...
  it('should call next middleware if user exists in session', () => {
    req.session.user = { id: '6489b58e7ea61d2d2679badc', email: 'ktapan176@gmail.com', name: 'A', role: 'user' };
...
describe('authenticate admin middleware', () => {
    ...
    it('should call next middleware if user exists in session', () => {
      req.session.user = { id: '6489b58e7ea61d2d2679badc', email: 'ktapan176@gmail.com', name: 'A', role: 'admin' };
